...
```mermaid
graph LR
  M["'PP.Роз''їзний характер роботи, грн'"]
...
Розрахункове поле   Відношення кількості працівників із зміною фіксованої винагороди за останні 12 місяців (включно із поточним місяцем) до  кількості працівників, які є членами команди станом на поточний момент і 12 міс. назад.   Вивести в деталізацію ПІБ таких працівників, види нарахувань, їх суми та період встановлення за ост.12 місяців)
