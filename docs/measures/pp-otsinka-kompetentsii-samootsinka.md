# PP.Оцінка компетенцій.Самооцінка
...
```dax
AVERAGE('fact_360_Assessment'[Self_Assessment])
```
...
Колонки: `fact_360_Assessment[Self_Assessment]`

### Схема

```mermaid
graph LR
  M["PP.Оцінка компетенцій.Самооцінка"]
