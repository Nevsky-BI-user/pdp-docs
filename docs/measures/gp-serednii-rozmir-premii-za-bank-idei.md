# GP.Середній розмір премії за Банк ідей
...
```mermaid
graph LR
  M["GP.Середній розмір премії за Банк ідей"]
...
**Бізнес-назва:** Середній розмір премії за Банк ідей

### Опис із ТЗ

Потрібно зсумувати значення поля `payments_fact_UAH`> 0.00 по тим працівникам, для яких `accrual_types_key` = '99c90425-4ca3-438f-b526-e006f8022f31' та `category_of_accrual_sort`  = '3' та поділити на кількість людей, які отримали такі виплати.   В деталізацію вивести перелік таких працівників та суму по кожному із них
