# PP.Оцінка компетенцій.Оцінка підлеглих
...
```dax
AVERAGE('fact_360_Assessment'[Subordinate_Assessment])
```
...
Колонки: `Subordinate_Assessment`
...
Колонки: `fact_360_Assessment[Subordinate_Assessment]`

### Схема

```mermaid
graph LR
  M["PP.Оцінка компетенцій.Оцінка підлеглих"]
