# GP.Середній розмір інвестиційного проєктного бонусу
...
```mermaid
graph LR
  M["GP.Середній розмір інвестиційного проєктного бонусу"]
...
**Бізнес-назва:** Середній розмір інвестиційного проєктного бонусу

### Опис із ТЗ

Потрібно зсумувати значення поля `payments_fact_UAH`> 0.00 по тим працівникам, для яких `accrual_types_key` = 9c613f71-f132-3652-2cd7-92995aa9311f' та `category_of_accrual_sort`  = '3' та поділити на кількість людей, які отримали такі виплати.   В деталізацію вивести перелік таких працівників та суму по кожному із них
