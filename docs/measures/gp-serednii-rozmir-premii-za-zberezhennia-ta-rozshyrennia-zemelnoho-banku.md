# GP.Середній розмір премії за збереження та розширення земельного банку
...
```mermaid
graph LR
  M["GP.Середній розмір премії за збереження та розширення земельного банку"]
...
**Бізнес-назва:** Середній розмір премії за збереження та розширення земельного банку

### Опис із ТЗ

Потрібно зсумувати значення поля `payments_fact_UAH`> 0.00 по тим працівникам, для яких `accrual_types_key` = '18f9ddbe-9571-b614-dda3-f65900e3807c' та `category_of_accrual_sort`  = '3' та поділити на кількість людей, які отримали такі виплати.   В деталізацію вивести перелік таких працівників та суму по кожному із них
