...
```mermaid
graph LR
  M["PP.Годин взаємодії у неробочий час (напрям)"]
...
**Використовує:** [PP.Годин взаємодії у неробочий час (Холдинг)](../measures/pp-hodyn-vzaiemodii-u-nerobochyi-chas-kholdynh.md)
