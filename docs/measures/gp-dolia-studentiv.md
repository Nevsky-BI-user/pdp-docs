...
VAR _admin = 
	DIVIDE(
		CALCULATE(
			...
			'fact_Employee_List'[POSITION_CATEGORY_INTERNAL_SORT] = 11
		),
		COUNTROWS('fact_Employee_List')
	)
VAR _admin_lt = 
...
**Бізнес-назва:** Доля студентів

### Опис із ТЗ

Розрахункове поле: відношення кількості Студентів у команді до загальної кількості працівників.   Деталі підрахунку будуть додані після доробки відповідного довідника та оновлення алгоритму розрахунку.
