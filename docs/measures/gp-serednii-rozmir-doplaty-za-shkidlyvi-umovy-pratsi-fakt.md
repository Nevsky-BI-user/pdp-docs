	...
	VAR _table0 = 
		ADDCOLUMNS(
			...
			CALCULATE(
				...
				'fact_TRS'[ACCRUAL_TYPES_KEY] = "c31b06b3-0fac-2fb2-cb4b-f806abbbfb95",
...
```mermaid
graph LR
  M["GP.Середній розмір доплати за шкідливі умови праці, факт"]
...
??? note "Поля-джерела та пов'язані бізнес-метрики (64)"
    | Поле | Бізнес-метрики |
    |---|---|
