...
**Бізнес-назва:** Кількість студентів

### Опис із ТЗ

Деталі підрахунку будуть додані після доробки відповідного довідника та оновлення алгоритму розрахунку.   Потрібно рахувати унікальну к-ть, щоб двічі не рахували тих, в кого осн місце і сумісництво.
