...
**Бізнес-назва:** Коефіцієнт індивідуального бонусу
...
??? note "Поля-джерела та пов'язані бізнес-метрики (5)"
    | Поле | Бізнес-метрики |
    |---|---|
    | `Ind_Bonus_Rate` | Коефіцієнт індивідуального бонусу · Коефіцієнт індивідуального бонусу ОКР · Значення коефіцієнта індивідуального бонусу за останній період · Значення коефіцієнта індивідуального бонусу за передостанній період · Тренд оцінки OKR |
