...
VAR _direction_res = 
CALCULATE(
	SUM('fact_EXCEL_Group_Profile_General_Metric'[Internal_Senior_Level_Fill]),
	FILTER(
...
Колонки: `DIRECTION`, `Direction_Name`, `EMPLOYEE_EMAIL`, `Internal_Senior_Level_Fill`, `ORDER_NUM_2`, `POSITION_CATEGORY_DETAIL`, `Record_Type`, `SUB_DIRECTION`
...
??? note "Поля-джерела та пов'язані бізнес-метрики (12)"
    ...
    | `Internal_Senior_Level_Fill` | Закриття позицій Senior+ внутрішніми кандидатами (%) |
