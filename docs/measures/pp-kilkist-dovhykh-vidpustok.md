...
**Бізнес-назва:** Кількість довгих відпусток за ост.12 місяців

### Опис із ТЗ

1 - Так   0 - Ні

Розрахункове поле.   В  деталізацію вивести загальну тривалість такихдовгих відпусток (`Long_Vacations_Total_Day`)
...
??? note "Поля-джерела та пов'язані бізнес-метрики (6)"
    ...
    | `Long_Vacation` | Наявність довгих відпусток (більше 10 днів) · Доля співробітників команди з наявними відпустками понад 10 днів · Рівень неякісних відпусток (%) · Кількість довгих відпусток за ост.12 місяців |
