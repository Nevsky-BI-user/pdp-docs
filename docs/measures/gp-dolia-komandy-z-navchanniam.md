...
**Бізнес-назва:** Доля команди з навчанням, %

### Опис із ТЗ

В звіті будуть dummy дані, поки не побудовані відповідні вітрини, які є джерелом даних.   Дані потрібно взяти за останні 12 місяців.
