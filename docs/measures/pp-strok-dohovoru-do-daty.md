...
**Бізнес-назва:** Строк договору до дати

### Опис із ТЗ

Документ Прием на работу в организацию - Строковий трудовий договір

Дата, до якої працює працівник по строковому трудовому договору по поточному наказу про прийом на роботу (`doc_job_application_id`)
