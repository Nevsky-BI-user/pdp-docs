...
CALCULATE(
	...
	fact_TRS[accrual_types_key]="99c90425-4ca3-438f-b526-e006f8022f31",
...
**Бізнес-назва:** Премія за Банк ідей

### Опис із ТЗ

Потрібно відібрати всі записи по працівнику `person_key`, періоду `Period`, організації `organization_key` , підрозділу `division_key`, посаді `position_key`, де  поле `accrual_types_key` = '99c90425-4ca3-438f-b526-e006f8022f31'   та `category_of_accrual_sort`  = '3' за останні 12 місяців, НЕ включаючи поточний.   Якщо по працівнику записи відсутні, то показати прочерк "-".   В деталізацію винести дані в табличному вигляді суму та місяць, за який було здійснено нарахування
