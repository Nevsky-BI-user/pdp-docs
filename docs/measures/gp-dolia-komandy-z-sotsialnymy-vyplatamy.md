# GP.Доля команди з соціальними виплатами, %
...
```mermaid
graph LR
  M["GP.Доля команди з соціальними виплатами, %"]
...
**Бізнес-назва:** Доля команди з соціальними виплатами, %

### Опис із ТЗ

Потрібно підрахувати кількість працівників в команді, для яких  значення поля `payments_fact_UAH`> 0.00 по `category_of_accrual_sort` = '5' за останні 12 місяців, НЕ включаючи поточний та поділити на поточну кількість членів команди.
