...
CALCULATE(
	SUMX(
		'fact_Employee_List',
		'fact_Employee_List'[MIN_TARIFF_RATE] * 'fact_Employee_List'[BONUS_QUARTER_SALARY_CNT]
	)
)
...
//     SUMX(
//         'fact_TRS_Plan',
//         fact_TRS_Plan[MIN_TARIFF_RATE] * 'fact_TRS_Plan'[BONUS_QUARTER_SALARY_CNT]
//     ),
...
Колонки: `BONUS_QUARTER_SALARY_CNT`, `CALC_TYPE_CODE`, `IS_ACTUAL`, `MIN_TARIFF_RATE`, `category_name`
...
Колонки: `fact_Employee_List[BONUS_QUARTER_SALARY_CNT]`, `fact_Employee_List[MIN_TARIFF_RATE]`, `fact_TRS_Plan[BONUS_QUARTER_SALARY_CNT]`, `fact_TRS_Plan[CALC_TYPE_CODE]`, `fact_TRS_Plan[IS_ACTUAL]`, `fact_TRS_Plan[MIN_TARIFF_RATE]`, `fact_TRS_Plan[category_name]`

### Схема

```mermaid
graph LR
  M["PP.Квартальна премія"]
...
**Бізнес-назва:** Квартальна премія
