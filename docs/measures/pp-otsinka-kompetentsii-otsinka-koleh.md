# PP.Оцінка компетенцій.Оцінка колег
...
```dax
AVERAGE('fact_360_Assessment'[Peer_Assessment])
```
...
Колонки: `fact_360_Assessment[Peer_Assessment]`

### Схема

```mermaid
graph LR
  M["PP.Оцінка компетенцій.Оцінка колег"]
