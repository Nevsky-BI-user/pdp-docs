...
```dax
VAR _seniority = SELECTEDVALUE(fact_employee_seniority_by_month[seniority_LAST_ORGANIZATION_HIRE_DATE])
...
Колонки: `seniority_LAST_ORGANIZATION_HIRE_DATE`
...
Колонки: `fact_employee_seniority_by_month[seniority_LAST_ORGANIZATION_HIRE_DATE]`

### Схема

```mermaid
graph LR
  M["PP.Стаж в організації (останній)"]
...
seniority_LAST_ORGANIZATION_HIRE_DATE → Стаж в організації

Значення поля в місяцях потрібно перевести в роки та місяці. Наприклад, якшо seniority_LAST_ORGANIZATION_HIRE_DATE= 17, то в звіті треба відобразити 1 рік 5 місяців.
