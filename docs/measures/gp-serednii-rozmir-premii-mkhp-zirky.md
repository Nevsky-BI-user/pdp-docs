# GP.Середній розмір премії МХП Зірки
...
```mermaid
graph LR
  M["GP.Середній розмір премії МХП Зірки"]
...
**Бізнес-назва:** Середній розмір премії МХП Зірки

### Опис із ТЗ

Потрібно зсумувати значення поля `payments_fact_UAH`> 0.00 по тим працівникам, для яких `accrual_types_key` = '9781d4aa-3a0d-1458-623a-7a93e90a2284' та `category_of_accrual_sort`  = '3' та поділити на кількість людей, які отримали такі виплати.   В деталізацію вивести перелік таких працівників та суму по кожному із них
