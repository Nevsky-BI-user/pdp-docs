...
**Бізнес-назва:** Кількість Ветеранів

### Опис із ТЗ

Розрахункове поле. Підрахувати скільки працівників у команді, де `is_veteran` = 1   Потрібно рахувати унікальну к-ть, щоб двічі не рахували тих, в кого осн місце і сумісництво.
