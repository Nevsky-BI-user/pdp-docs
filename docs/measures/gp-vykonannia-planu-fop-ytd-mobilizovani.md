# GP.Виконання плану ФОП YTD (%) Мобілізовані
...
```mermaid
graph LR
  M["GP.Виконання плану ФОП YTD (%) Мобілізовані"]
```
...
**Бізнес-назва:** Виконання плану ФОП YTD (%) Мобілізовані

### Опис із ТЗ

Аналогічний показник, але по всім працівникам в статусі Мобілізований
