# GP.Доля команди з доплатою за шкідливі умови праці, % факт
...
```mermaid
graph LR
  M["GP.Доля команди з доплатою за шкідливі умови праці, % факт"]
...
**Бізнес-назва:** Доля команди з доплатою за шкідливі умови праці, % факт

### Опис із ТЗ

Розрахункове поле.   Потрібно підрахувати кількість працівників у команді для яких є хоча б один запис за останні 12 міс. по `accrual_types_key` = c31b06b3-0fac-2fb2-cb4b-f806abbbfb95, де  поле `PAYMENTS_FACT_UAH`>0 та поділити на поточну кількість членів команди.
