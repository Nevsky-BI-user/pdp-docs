# GP.Середній розмір проектного бонус за стратегічні ІТ проєкти
...
```mermaid
graph LR
  M["GP.Середній розмір проектного бонус за стратегічні ІТ проєкти"]
...
**Бізнес-назва:** Середній розмір проектного бонус за стратегічні ІТ проєкти

### Опис із ТЗ

Потрібно зсумувати значення поля `payments_fact_UAH`> 0.00 по тим працівникам, для яких `accrual_types_key` = '8892e575-4037-2f78-ec86-2cdea2b3fbae' та `category_of_accrual_sort`  = '3' та поділити на кількість людей, які отримали такі виплати.   В деталізацію вивести перелік таких працівників та суму по кожному із них
