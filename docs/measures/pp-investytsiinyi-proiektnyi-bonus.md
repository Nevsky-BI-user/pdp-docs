# PP.Інвестиційний проєктний бонус
...
CALCULATE(
	...
	fact_TRS[accrual_types_key]="9c613f71-f132-3652-2cd7-92995aa9311f",
...
```mermaid
graph LR
  M["PP.Інвестиційний проєктний бонус"]
  M --> dim_Date["dim_Date"]
  M --> fact_TRS["fact_TRS"]
```
...
**Бізнес-назва:** Інвестиційний проєктний бонус

### Опис із ТЗ

Потрібно відібрати всі записи по працівнику `person_key`, періоду `Period`, організації `organization_key` , підрозділу `division_key`, посаді `position_key`, де  поле `accrual_types_key` = '9c613f71-f132-3652-2cd7-92995aa9311f'   та `category_of_accrual_sort`  = '2' за останні 12 місяців, НЕ включаючи поточний.   Якщо по працівнику записи відсутні, то показати прочерк "-".   В деталізацію винести дані в табличному вигляді суму та місяць, за який було здійснено нарахування
