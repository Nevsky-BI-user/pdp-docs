...
**Бізнес-назва:** Результативність по KPI (%)
...
**Використовує:** [AC.Дані.Результативність по KPI (%)](../measures/ac-dani-rezultatyvnist-po-kpi.md), [AC.Оцінка.Результативність по KPI (%)](../measures/ac-otsinka-rezultatyvnist-po-kpi.md)
