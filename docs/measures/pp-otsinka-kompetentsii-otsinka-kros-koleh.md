# PP.Оцінка компетенцій.Оцінка крос-колег
...
```dax
AVERAGE('fact_360_Assessment'[Cross_Peer_Assessment])
```
...
Колонки: `fact_360_Assessment[Cross_Peer_Assessment]`

### Схема

```mermaid
graph LR
  M["PP.Оцінка компетенцій.Оцінка крос-колег"]
