...
**Бізнес-назва:** На чиєму місці сидить

### Опис із ТЗ

В звіті будуть dummy дані, поки не побудовані відповідні вітрини, які є джерелом даних   Потрібно прізвище працівника, який займав цю посаду (найперший), коли на той же самий код ЦБ посади приймають іншого працівника

Потрібно прізвище працівника, який займав цю посаду (найперший), коли на той же самий код ЦБ посади приймають іншого працівника   `employee_ID` - код відсутнього працівника. Потрібно відібрати запис із найменшою датою в полі Period   `employee_emp_id` або `employee_worker_id`- код працівника, якого прийнято на посаду. Документи 1С - ТЧ "Отсутсвующие сотрудники" документа Кадровое перемещение та ТЧ "Отсутсвующие сотрудники" документа Прием на работу
