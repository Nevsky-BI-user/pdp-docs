...
**Бізнес-назва:** Середній дохід без річного бонуса (за ост. 12 міс)
...
??? note "Поля-джерела та пов'язані бізнес-метрики (4)"
    ...
    | `MONTLY_INCOME_WITHOUT_BONUS` | Середній дохід без річного бонуса (за ост. 12 міс) |
