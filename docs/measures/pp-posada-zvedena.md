...
**Бізнес-назва:** Посада зведена

### Опис із ТЗ

В звіті будуть dummy дані, поки не побудовані відповідні вітрини, які є джерелом даних

Джерелом даних є регістр сведений 1С "Соответствие Должность - Сводная должность" та довідник "Сводные должности"

Назва зведеної посади. Джерелом даних є регістр сведений 1С "Соответствие Должность - Сводная должность" та довідник "Сводные должности"
