...
JOB_TITLE_PART_TIME_NAME → Посада по суміщенню; PERIOD → Дата нарахування премії Зірка МХП; PERIOD → Дата; PERIOD → Період нарахування; PERIOD → Період
...
VAR _res = 
    CALCULATE(
        SELECTEDVALUE(fact_Employee_History_Position[JOB_TITLE_PART_TIME_NAME]),
...
Колонки: `JOB_TITLE_PART_TIME_NAME`, `PERIOD`
...
Колонки: `fact_Employee_History_Position[JOB_TITLE_PART_TIME_NAME]`, `fact_Employee_History_Position[PERIOD]`
