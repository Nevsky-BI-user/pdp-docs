...
**Бізнес-назва:** Категорія механізатора

### Опис із ТЗ

Дані відсутні в побудованих вітринах. Потрібно досліджувати джерело. Буде додано пізніше.

Категорію механізатора брати із довідника dwh.`dim_accrual_category`
