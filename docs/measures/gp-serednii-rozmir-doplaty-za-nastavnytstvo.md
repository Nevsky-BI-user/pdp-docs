# GP.Середній розмір доплати за наставництво
...
```mermaid
graph LR
  M["GP.Середній розмір доплати за наставництво"]
...
**Бізнес-назва:** Середній розмір доплати за наставництво

### Опис із ТЗ

Потрібно зсумувати значення поля `payments_fact_UAH`> 0.00 по тим працівникам, для яких `accrual_types_key` = '83ce68c2-8a36-d6d5-21bd-27fc6b970114' та `category_of_accrual_sort`  = '3' та поділити на кількість людей, які отримали такі виплати.   В деталізацію вивести перелік таких працівників та суму по кожному із них
