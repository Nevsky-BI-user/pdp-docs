...
**Бізнес-назва:** Інтервал взаємодії Тренд (%)
...
**Використовує:** [AC.Дані.Інтервал взаємодії Тренд (%)](../measures/ac-dani-interval-vzaiemodii-trend.md), [AC.Оцінка.Інтервал взаємодії Тренд (%)](../measures/ac-otsinka-interval-vzaiemodii-trend.md)
