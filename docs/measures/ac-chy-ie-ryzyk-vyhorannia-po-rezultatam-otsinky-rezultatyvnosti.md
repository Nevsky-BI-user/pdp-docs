# AC.Чи є ризик вигорання по результатам оцінки результативності?
...
VAR _val = SELECTEDVALUE('fact_Burnout_Indicators'[IS_PERFORMANCE_RISK])
...
Колонки: `fact_Burnout_Indicators[IS_PERFORMANCE_RISK]`

### Схема

```mermaid
graph LR
  M["AC.Чи є ризик вигорання по результатам оцінки результативності?"]
...
**Бізнес-назва:** Чи є ризик вигорання по результатам оцінки результативності?

### Опис із ТЗ

Якщо `Performance_Rate_Trend` = Спадання, то Ризик. Інакше - Відсутній.

??? note "Поля-джерела та пов'язані бізнес-метрики (1)"
    | Поле | Бізнес-метрики |
    |---|---|
    | `IS_PERFORMANCE_RISK` | Чи є ризик вигорання по результатам оцінки результативності? |
