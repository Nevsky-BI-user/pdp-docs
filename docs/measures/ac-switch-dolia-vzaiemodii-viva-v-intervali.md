...
Міри: [AC.Дані.Доля взаємодії (Viva) в інтервалі (%)](../measures/ac-dani-dolia-vzaiemodii-viva-v-intervali.md), [AC.Оцінка.Доля взаємодії (Viva) в інтервалі (%)](../measures/ac-otsinka-dolia-vzaiemodii-viva-v-intervali.md)
