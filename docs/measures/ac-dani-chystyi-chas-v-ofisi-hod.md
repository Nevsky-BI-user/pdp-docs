# AC.Дані.Чистий час в офісі, год.
...
```dax
VAR _res = SELECTEDVALUE('fact_Loss_of_Productivity'[Net_Office_Time_AVG_3month])
...
```mermaid
graph LR
  M["AC.Дані.Чистий час в офісі, год."]
...
**Бізнес-назва:** Чистий час в офісі, год.
...
**Використовується в:** [AC.Switch.Чистий час в офісі, год.](../measures/ac-switch-chystyi-chas-v-ofisi-hod.md)
