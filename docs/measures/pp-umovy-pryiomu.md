...
**Бізнес-назва:** Умови прийому

### Опис із ТЗ

Потрібно змапити із українськими відповідниками   ВРЕМЕННО - Тимчасово   БЕССРОЧНО - Безстроково   НА_ПЕРИОД_ОТСУТСТВИЯ_ОСНОВНОГО_РАБОТНИКА - На період відсутності основного працівника   НА_ОПРЕДЕЛЕННЫЙ_СРОК - На визначений термін   ПЕРЕВОД - перевод   Якщо значення в полі відсутнє, то показати текст "Дані відсутні"  або знак "-".
