...
**Бізнес-назва:** Середні витрати на оренду житла

### Опис із ТЗ

Розрахункове.   Потрібно зсумувати значення поля `INIT_PAYMENT_PLAN_SUM`, де `ACCRUAL_ORG_CODE` = 00144, `IS_ACTUAL`  = "1", `END_DATE` > поточна дата, або `END_DATE` = "01.01.2001 та поділити на кількість членів команди, у яких є такий вид нарахування в планових виплатах.   В деталізацію вивести перелік таких працівників та суму на оренду житла по кожному із них
