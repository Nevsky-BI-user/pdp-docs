# t_Loss_Productivity_Metrics_by_Persona
...
| База | `mhpdwhdev01` |
| Power Query | `t_Loss_Productivity_Metrics_by_Persona` |
| Джерела | `DWH.t_SPO_HR_Person_Matrix_with_Coefficient` |

## Колонки

| Колонка | Тип | Джерело | Calc |
|---|---|---|---|
| SubPerson | string | SubPerson |  |
